...
def run_training(epochs: int = None):
    ...
    Args:
        epochs: Number of epochs for training. If None, use the value from the config.
    """
    ...
    for ep in tqdm(range(1, epochs + 1)):
        ...
        if ep % interval_value == 0:# save interval: TODO: old 500
            print(f"Saving model {ep} from {epochs}")
            name = f"model_{ep}_from_{epochs}.pt"
